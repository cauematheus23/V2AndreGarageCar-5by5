...
namespace AndreGarageSendBankSQL.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class BanksController : ControllerBase
    {
        private readonly AndreGarageSendBankSQLContext _context;

        public BanksController(AndreGarageSendBankSQLContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Bank>> PostBank(Bank bank)
        {
          if (_context.Bank == null)
          {
              return Problem("Entity set 'AndreGarageSendBankSQLContext.Bank'  is null.");
          }
